...
namespace Tools_starfield
{
    class Sprite
    {
        ...
        public Vector2 Center
        {
            get
            {
                return position + new Vector2(frameWitdh / 2, frameHeight / 2);
            }
        }
        ...
        public virtual void Draw (SpriteBatch spriteBatch)
        {
            spriteBatch.Draw(
                ...
                tintColor,
                rotation,
                new Vector2(frameWitdh / 2, frameHeight / 2),
                1.0f,
                SpriteEffects.None,
                0.0f);
        }
